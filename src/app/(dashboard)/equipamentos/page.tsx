    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-end justify-center gap-2 p-3 bg-card border border-border rounded-lg">
        ...
        <div className="flex flex-col gap-0.5">
          ...
          <input placeholder="SKU" value={filters.sku} onChange={e => setFilter("sku", e.target.value)} className="w-[120px] h-8 text-sm bg-background border border-border rounded px-2 text-foreground placeholder:text-muted-foreground/50 outline-none focus:border-primary/50" />
        </div>
        <div className="flex flex-col gap-0.5">
          <span className="text-xs text-muted-foreground">Categoria</span>
          <input placeholder="Categoria" value={filters.category} onChange={e => setFilter("category", e.target.value)} className="w-[130px] h-8 text-sm bg-background border border-border rounded px-2 text-foreground placeholder:text-muted-foreground/50 outline-none focus:border-primary/50" />
        </div>
        <div className="flex flex-col gap-0.5">
          <span className="text-xs text-muted-foreground">Marca</span>
          <input placeholder="Marca" value={filters.brand} onChange={e => setFilter("brand", e.target.value)} className="w-[120px] h-8 text-sm bg-background border border-border rounded px-2 text-foreground placeholder:text-muted-foreground/50 outline-none focus:border-primary/50" />
        </div>
        <div className="flex flex-col gap-0.5">
