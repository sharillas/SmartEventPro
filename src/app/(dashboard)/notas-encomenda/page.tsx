    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-end justify-center gap-2 p-3 bg-card border border-border rounded-lg">
        <div className="flex flex-col gap-0.5">
          <span className="text-xs text-muted-foreground">N.º NE</span>
        ...
        <div className="flex flex-col gap-0.5">
          ...
          <input placeholder="Fornecedor" value={filters.supplier} onChange={e => setFilter("supplier", e.target.value)} className="w-[150px] h-8 text-sm bg-background border border-border rounded px-2 text-foreground placeholder:text-muted-foreground/50 outline-none focus:border-primary/50" />
        </div>
        <div className="flex flex-col gap-0.5">
