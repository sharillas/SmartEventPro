...
## Instalação VPS (Debian/Ubuntu) — do zero

```bash
wget https://raw.githubusercontent.com/sharillas/SmartEventPro/main/install.sh
chmod +x install.sh
sudo ./install.sh
```

O script instala automaticamente: git, Node.js 22, Nginx, PM2, dependências, base de dados, build e SSL.
